...
Esta pasta concentra documentação técnica e templates reutilizáveis do projeto.

## Visão técnica

- [`TECHNICAL_OVERVIEW.md`](TECHNICAL_OVERVIEW.md) — propósito, progressão técnica, método de estudo e critérios de validação.
